...
```{r}
U1.ed.diag = lapply(U1.ed, function(U) U + 0.01 * diag(8))
m1.fit.diff.diag = mash(m1.data, c(U1.c, U1.ed.diag))
...
Add a small number on the diagonal of priors:
```{r}
U2.ed.diag = lapply(U2.ed, function(U) U + 0.01 * diag(8))
m2.fit.mean.diag = mash(m2.data.L, c(U2.c, U2.ed.diag))
