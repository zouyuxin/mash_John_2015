...
saveRDS(cov_ed(data.strong, U.ed), '../output/Expression18_EE_jointdiff_ED.rds')
```
...
```{r mash, eval=FALSE}
saveRDS(mash(mash.data, c(U.c, U.ed, U.dd[c('PCA_1','PCA_2','PCA_3', paste0('Flash_',1:8))])), '../output/Expression18_jointdiff_mash_model.rds') 
```
