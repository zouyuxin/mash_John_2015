...
U.ed = U.dd[c('tPCA', 'tFlash', 'XX')]
saveRDS(cov_ed(data.strong.L, U.ed), '../output/Expression18_EE_jointmean_ED.rds')
```
...
```{r mash, eval=FALSE}
saveRDS(mash(mash.data.L, c(U.c, U.ed, U.dd[c('PCA_1','PCA_2','PCA_3', paste0('Flash_',1:9))])), '../output/Expression18_jointmean_mash_model.rds') 
```
