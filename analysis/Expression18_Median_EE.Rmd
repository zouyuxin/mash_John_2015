---
title: "Expression 18 Mash Median- EE"
author: "Yuxin Zou"
date: 2020-12-9
output: 
  html_document:
...
mash.data.L = mash_set_data(delta, Shat = mash.data$Shat)
```
...
data.strong.L = mash_set_data(Bhat = mash.data.L$Bhat[strong,], Shat = mash.data.L$Shat[strong,])
```
...
saveRDS(cov_ed(data.strong.L, U.dd), '../output/Expression18_Median_EE_ED.rds')
```

## Mash model

```{r}
U.ed = readRDS('../output/Expression18_Median_EE_ED.rds')
```

```{r mash, eval=FALSE}
saveRDS(mash(mash.data.L, c(U.c, U.ed)), '../output/Expression18_Median_EE_mash_model.rds') 
```

## Result

```{r}
mash.model = readRDS('../output/Expression18_Median_EE_mash_model.rds')
```
...
Check Flash1 covariance matrix
...
gene1177$Group = factor(c('none','Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene1177.post$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene7637$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene7637.post$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene93$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene93.post$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene11445$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene11445.post$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene2481$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
...
gene2481.post$Group = factor(c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('none', 'Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
