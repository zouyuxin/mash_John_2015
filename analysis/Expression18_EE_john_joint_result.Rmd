...
# before 11952
gene3696 = data.frame(mash.data.L$Bhat[3696,])
colnames(gene3696) = 'Deviations'
gene3696$Group = factor(c('Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
gene3696$se = mash.data.L$Shat[3696,]
gene3696$Deviations[gene3696$se == 0] = NA
# after
gene3696.post = data.frame(m.model$result$PosteriorMean[3696,])
colnames(gene3696.post) = 'Deviations'
gene3696.post$Group = factor(c('Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'), levels = c('Rv', 'Rvplus', 'GC', 'BCG', 'Smeg', 'Yers', 'Salm', 'Staph'))
gene3696.post$se = m.model$result$PosteriorSD[3696,]

p.orig = ggplot(gene3696, aes(y = Deviations, x = Group, color=Group)) + 
  geom_point() + ylim(-1.5,0.5) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(),axis.line = element_line(colour = "black"), legend.position = "none", plot.title = element_text(size = 10), axis.text=element_text(size=10)) + coord_flip() + ggtitle('ENSG00000117408 original' )

p.post = ggplot(gene3696.post, aes(y = Deviations, x = Group, color=Group)) + 
  geom_point() + ylim(-1.5,0.5) +
  geom_errorbar(aes(ymin=Deviations-1.96*se, ymax=Deviations+1.96*se), width=0.4) + 
  geom_hline(yintercept = 0, linetype="dotted", color = "grey", size=1) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),axis.line = element_line(colour = "black"), legend.position = "none", plot.title = element_text(size = 10), axis.text=element_text(size=10)) + coord_flip() + ggtitle('ENSG00000117408 mash')
...
```{r allgene4, fig.height=5, fig.width=10}
# before 1535
...
p.orig = ggplot(gene1535, aes(y = Deviations, x = Group, color=Group)) + 
  ...
  geom_errorbar(aes(ymin=Deviations-1.96*se, ymax=Deviations+1.96*se), width=0.4) + 
  geom_hline(yintercept = 0, linetype="dotted", color = "grey", size=1) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(),axis.line = element_line(colour = "black"), legend.position = "none", plot.title = element_text(size = 10), axis.text=element_text(size=10)) + coord_flip() + ggtitle('ENSG00000090920 original' )

p.post = ggplot(gene1535.post, aes(y = Deviations, x = Group, color=Group)) + 
  geom_point() + ylim(-8, 3) +
  geom_errorbar(aes(ymin=Deviations-1.96*se, ymax=Deviations+1.96*se), width=0.4) + 
  geom_hline(yintercept = 0, linetype="dotted", color = "grey", size=1) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),axis.line = element_line(colour = "black"), legend.position = "none", plot.title = element_text(size = 10), axis.text=element_text(size=10)) + coord_flip() + ggtitle('ENSG00000090920 mash')
...
p.orig = ggplot(gene5252, aes(y = Deviations, x = Group, color=Group)) + 
  ...
  geom_errorbar(aes(ymin=Deviations-1.96*se, ymax=Deviations+1.96*se), width=0.4) +
  geom_hline(yintercept = 0, linetype="dotted", color = "grey", size=1) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(),axis.line = element_line(colour = "black"), legend.position = "none", plot.title = element_text(size = 10), axis.text=element_text(size=10)) + coord_flip() + ggtitle('ENSG00000134321 original' )

p.post = ggplot(gene5252.post, aes(y = Deviations, x = Group, color=Group)) + 
  geom_point() + 
  geom_errorbar(aes(ymin=Deviations-1.96*se, ymax=Deviations+1.96*se), width=0.4) + 
  geom_hline(yintercept = 0, linetype="dotted", color = "grey", size=1) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(),axis.line = element_line(colour = "black"), legend.position = "none", plot.title = element_text(size = 10), axis.text=element_text(size=10)) + coord_flip() + ggtitle('ENSG00000134321 mash')
