...
```{r mash, eval=FALSE}
U.dd.diag = c(U.ed[c('ED_tPCA', 'ED_tFlash', 'ED_XX')], lapply(U.ed[c('ED_PCA_1','ED_PCA_2','ED_PCA_3', paste0('ED_Flash_',1:7))], function(U) U + 0.01*diag(8)))
...
All in Cormofit, non-significant in mash.
