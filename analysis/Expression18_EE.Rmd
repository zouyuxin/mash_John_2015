...
```{r sharingMagSign}
x = get_pairwise_sharing(mash.model, factor = 0.8)
x[x > 1]    <- 1
x[x < -1]   <- -1
...
```{r allgene1}
which(rownames(beta_class) == 'ENSG00000006015')
# before
...
```{r allgene2}
which(rownames(beta_class) == 'ENSG00000196639')
# before
...
```{r allgene3}
which(rownames(beta_class) == 'ENSG00000105497')
# before
